                        ...
                        <div class="card card-widget widget-user">
                            <div class="widget-user-header bg-info">
                                <div class="widget-user-image">
                                    <img class="img-circle elevation-2"
                                         src="{{ asset('storage/' . $user->picture_path) }}" alt="User Avatar">
                                </div>
                            ...
                            <div class="card-body">
                                ...
                                <div class="mt-3">
                                    ...
                                    <div class="progress">
                                        <div class="progress-bar bg-success" role="progressbar" style="width: 6.67%"
                                             aria-valuenow="6.67" aria-valuemin="0" aria-valuemax="100"></div>
                                    </div>
                                </div>
                                <hr>
                                <!-- Shaxsiy Ma'lumotlar -->
                                ...
                                <table class="table">
                                    ...
                                    @if($user->employee->departments[0]->pivot->role_id == 2)
                                        <tr>
                                            <td>
                                ...
                                <div class="card border-info">
                                    ...
                                    <div class="card-body">
                                        <div class="list-group">
                                            ...
                                            <div class="list-group-item d-flex align-items-start mb-3">
                                                <img src="../dist/img/user5-128x128.jpg" alt="User Avatar"
                                                     class="img-circle elevation-2" style="width: 60px; height: 60px;">
                                                <div class="ml-3">
                                            ...
                                            <div class="list-group-item d-flex align-items-start">
                                                <img src="../dist/img/user6-128x128.jpg" alt="User Avatar"
                                                     class="img-circle elevation-2" style="width: 60px; height: 60px;">
                                                <div class="ml-3">
                                        ...
                                        <ul class="list-group">
                                            ...
                                            <span class="mr-2">
                                                <img src="../dist/img/user1-128x128.jpg" alt="User Avatar"
                                                     class="img-circle elevation-2" style="width: 50px; height: 50px;">
                                            </span>
                                            ...
                                            <span class="mr-2">
                                                ...
                                                <div class="flex-grow-1">
                                                    ...
                                                    <br>
                                                    <small class="text-muted">Mutaxasislik: Tizimlar
                                                        muhandisligi</small>
                                                    <br>
                                        ...
                                        <ul class="list-group">
                                            ...
                                            <span class="mr-2">
                                                ...
                                                <div class="flex-grow-1">
                                                    <span style="font-weight: bold;">Toshkentov Azamat</span>
                                                    <br>
                                                    <small class="text-muted">Fakultet: Informatika <br>Kafedra: MICHA
                                                    </small>
                                                </div>
                                                <span class="badge bg-primary">95</span>
                                            </li>
                                            ...
                                            <span class="mr-2">
                                                ...
                                                <div class="flex-grow-1">
                                                    <span style="font-weight: bold;">Sirojiddinova Dildora</span>
                                                    <br>
                                                    <small class="text-muted">Fakultet: Informatika <br>Kafedra:
                                            ...
                                            <span class="mr-2">
                                                ...
                                                <div class="flex-grow-1">
                                                    <span style="font-weight: bold;">Karimov Sherzod</span>
                                                    <br>
                                                    <small class="text-muted">Fakultet: Informatika <br>Kafedra: Sun'iy
                                                        intellekt </small>
                                                </div>
                                                <span class="badge bg-primary">90</span>
                                            </li>
