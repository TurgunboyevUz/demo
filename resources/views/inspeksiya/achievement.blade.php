                    ...
                    <div class="card">
                        <div class="card-header d-flex justify-content-between align-items-center">
                            ...
                            <div class="ml-auto d-flex">
                                <button id="zipDownload" class="btn btn-success" data-url="{{ route('storage.zip') }}" data-csrf="{{ csrf_token() }}" data-name="achievements">
                                ...
                                <table id="achievementsTable" class="table table-bordered table-responsive table-striped">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <button class="btn btn-sm btn-success confirmAction" data-id="{{ $item->achievement->id }}" data-url="{{ route('employee.inspeksiya.achievement.approve') }}" data-csrf="{{ csrf_token() }}"><i class="fas fa-check"></i></button>
                                                <button class="btn btn-sm btn-danger cancelAction" data-id="{{ $item->achievement->id }}" data-url="{{ route('employee.inspeksiya.achievement.reject') }}" data-csrf="{{ csrf_token() }}"><i class="fas fa-ban"></i></button>
                                            </td>
